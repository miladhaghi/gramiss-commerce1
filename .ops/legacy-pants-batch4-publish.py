...
TARGETS={222:{'title':'شلوارجین نیم بگ ساده','excerpt':'شلوار جین نیم‌بگ ساده؛ برای این مدل سایزهای 31، 32، 33، 34، 36 و 38 تعریف شده است.'},231:{'title':'شلوار بگ زاپدار','excerpt':'شلوار جین بگ زاپ‌دار؛ برای این مدل سایزهای M، L، XL و 2XL تعریف شده است.'},239:{'title':'شلوار جین بالنی تینت سبز','excerpt':'شلوار جین بالنی تینت سبز؛ برای این مدل سایزهای 31، 32، 33، 34 و 36 تعریف شده است.'},248:{'title':'شلوار جین بالنی آبی روشن','excerpt':'شلوار جین بالنی آبی روشن؛ برای این مدل سایزهای 30، 31 و 34 تعریف شده است.'},254:{'title':'شلوارجین فول بگ آبی روشن','excerpt':'شلوار جین فول‌بگ آبی روشن؛ برای این مدل سایزهای M، L و XL تعریف شده است.'}}
def safe(u):
...
def get(u,timeout=150):
 ...
 for n in range(5):
  try:
   r=urllib.request.Request(u,headers={'User-Agent':'GramissLegacyPantsBatch4/1.0','Cache-Control':'no-cache','Pragma':'no-cache'})
...
try:
 ...
 print('PASS LEGACY PANTS SHORT DESCRIPTION BATCH 4')
