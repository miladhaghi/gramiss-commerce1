...
def get(u):
 r=urllib.request.Request(u,headers={'User-Agent':'GramissProduct439TitleRepair/1.0','Cache-Control':'no-cache','Pragma':'no-cache'});return urllib.request.urlopen(r,context=CTX,timeout=180).read()
