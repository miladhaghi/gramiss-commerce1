...
$g1_look_2_spots = array(
    array( 'key' => 'cap',   'label' => 'کلاه فیت کپ', 'x' => '52%', 'y' => '10%', 'soon' => true ),
    array( 'key' => 'tee',   'label' => 'تیشرت',       'x' => '52%', 'y' => '34%', 'product' => $g1_product_data( 392, 'فرم باکسی + واش وینتیج؛ پایه‌ی اصلی استایل خیابانی.' ) ),
    array( 'key' => 'pants', 'label' => 'شلوار',       'x' => '50%', 'y' => '65%', 'product' => $g1_product_data( 284, 'فرم بگ کارگو + حجم کنترل‌شده؛ مناسب ترکیب با بالاتنه باکسی.' ) ),
    array( 'key' => 'shoes', 'label' => 'کتونی',       'x' => '51%', 'y' => '92%', 'product' => $g1_product_data( 435, 'فرم Chunky و حجیم؛ تعادل بصری مناسب برای شلوار بگ.' ) ),
);

$g1_look_1_spots = array(
    array( 'key' => 'shirt', 'label' => 'پیراهن', 'x' => '51%', 'y' => '29%', 'product' => $g1_product_data( 350, 'پارچه سیلکی + افت نرم؛ ظاهر تمیز و Relaxed بدون خشکی رسمی.' ) ),
    array( 'key' => 'pants', 'label' => 'شلوار',  'x' => '51%', 'y' => '64%', 'product' => $g1_product_data( 366, 'کرپ لَخت + فرم بگ و قد بلند؛ حجم نرم و مرتب روی کتونی.' ) ),
    array( 'key' => 'shoes', 'label' => 'کتونی',  'x' => '50%', 'y' => '92%', 'product' => $g1_product_data( 403, 'لژ ملایم + فرم تمیز؛ هماهنگ با شلوار روشن و استایل Old Money.' ) ),
);
    ...
    <div class="g1-looks__scene">
        <article class="g1-looks__look g1-looks__look--street" aria-label="Look 02 — Street / Relaxed">
            ...
            <div class="g1-looks__model-stage">
                <img src="<?php echo esc_url( $g1_theme_uri . '/assets/images/home/gramiss-look-02.webp' ); ?>" width="1024" height="1536" loading="lazy" decoding="async" alt="استایل خیابانی Gramiss با تیشرت باکسی، شلوار بگ، کتونی و کلاه">
        ...
        <article class="g1-looks__look g1-looks__look--oldmoney" aria-label="Look 01 — Clean / Old Money">
            ...
            <div class="g1-looks__model-stage">
                <img src="<?php echo esc_url( $g1_theme_uri . '/assets/images/home/gramiss-look-01.webp' ); ?>" width="1024" height="1536" loading="lazy" decoding="async" alt="استایل Old Money گرمیس با پیراهن آبی، شلوار کرم و کتونی سرمه‌ای">
