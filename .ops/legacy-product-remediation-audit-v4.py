...
EXPECTED={163:"تیشرت باکسی سنگشور طرح I'm Sorry با یقه‌گرد و طراحی چاپی، در رنگ‌های زرشکی و ذغالی و سایز L ارائه می‌شود.",167:'تیشرت باکس سنگشور طرح Me vs Me با یقه‌گرد و طراحی چاپی، در سایز L ارائه می‌شود.',197:'تیشرت کراپ باکس سنگشور طرح HORAE با یقه‌گرد و طراحی چاپی، در رنگ‌های کرم و ذغالی و سایزهای M و L ارائه می‌شود.',202:'تیشرت باکس سنگشور طرح Greedy با یقه‌گرد و طراحی چاپی، در رنگ‌های قهوه‌ای و ذغالی و سایزهای L و XL ارائه می‌شود.',215:'تیشرت باکس سنگشور طرح BackHouse با یقه‌گرد و طراحی چاپی، در سایزهای M و L ارائه می‌شود.',113:'تیشرت باکسی سنگشور دو تکه طرح مسیح با یقه‌گرد و طراحی چاپی، در سایزهای M، L و XL ارائه می‌شود.',119:'تیشرت باکسی سنگشور طرح closer با یقه‌گرد و طراحی چاپی، در رنگ‌های ذغالی و طوسی و سایزهای M و L ارائه می‌شود.',150:'تیشرت باکسی سنگشور طرح A.D.F با یقه‌گرد و طراحی چاپی، در رنگ‌های سرمه‌ای و سفید و سایزهای M و L ارائه می‌شود.',175:'تیشرت باکس طرح Chanyoou با یقه‌گرد و طراحی چاپی، در سایزهای M، L و XL ارائه می‌شود.',181:'تیشرت سنگشور باکس طرح Warnning با یقه‌گرد و طراحی چاپی، در رنگ‌های سبز و سرمه‌ای و سایزهای M، L و XL ارائه می‌شود.',374:'تیشرت باکسی سنگشور طرح Romance با طراحی چاپی؛ برای این مدل رنگ ذغالی و سایزهای M، L و XL تعریف شده است.',380:'تیشرت باکس سنگشور طرح Only God Can... با طراحی چاپی؛ برای این مدل رنگ‌های ذغالی و قهوه‌ای و سایزهای M، L و XL تعریف شده است.',392:'تیشرت باکس طرح مسیح با یقه‌گرد و طراحی چاپی؛ برای این مدل رنگ‌های سرمه‌ای و قهوه‌ای و سایزهای M، L و XL تعریف شده است.',222:'شلوار جین نیم‌بگ ساده؛ برای این مدل سایزهای 31، 32، 33، 34، 36 و 38 تعریف شده است.',231:'شلوار جین بگ زاپ‌دار؛ برای این مدل سایزهای M، L، XL و 2XL تعریف شده است.',239:'شلوار جین بالنی تینت سبز؛ برای این مدل سایزهای 31، 32، 33، 34 و 36 تعریف شده است.',248:'شلوار جین بالنی آبی روشن؛ برای این مدل سایزهای 30، 31 و 34 تعریف شده است.',254:'شلوار جین فول‌بگ آبی روشن؛ برای این مدل سایزهای M، L و XL تعریف شده است.'}
def safe(u):
...
def get(u,timeout=150):
 ...
 for n in range(5):
  try:
   r=urllib.request.Request(u,headers={'User-Agent':'GramissLegacyRemediationAuditV4/1.0','Cache-Control':'no-cache','Pragma':'no-cache'})
...
nonce=hashlib.sha256((str(time.time())+pre['front-page.php']).encode()).hexdigest()[:12];name='gramiss-remediation-audit-v4-'+nonce+'.php';ids=','.join(map(str,EXPECTED))
...
if d.get('empty_excerpt')!=29:errs.append('empty_excerpt')
...
print('PASS LEGACY PRODUCT REMEDIATION AUDIT V4')