...
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<div class="g1-announcement">انتخاب بهتر، خرید مطمئن‌تر <span>ارسال به سراسر ایران</span></div>
<header class="site-header" aria-label="ناوبری اصلی">
    <div class="gramiss-container header-inner">
        ...
        <form class="g1-header-search" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            ...
            <input id="g1-product-search" type="search" name="s" placeholder="جست‌وجوی محصول، استایل یا راهنما" value="<?php echo esc_attr( get_search_query() ); ?>">
            <input type="hidden" name="post_type" value="product">
        </form>

        <div class="header-actions">
            <button class="search-toggle" type="button" aria-label="جست‌وجو">
                <svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="11" cy="11" r="7"/><path d="m20 20-3.5-3.5"/></svg>
            </button>
